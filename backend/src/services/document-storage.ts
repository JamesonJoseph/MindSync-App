...
export async function storeUserPdf(uid: string, fileName: string, content: Buffer): Promise<{
  storagePath: string;
  fileName: string;
  fileSize: number;
}> {
...
export function resolveUserUploadPath(uid: string, storagePath: string): string {
